...
<body>
    <form class="form-container" method="post">
        <label class="form-label" for="convertstr">lower TO upper && upper to low:</label>
    ...
    if (isset($_POST['convertstr'])) {
        ...
        if ($inputString === strtolower($inputString)) {
            $convertString .= strtoupper($inputString);
        } else {
            $convertString .= strtolower($inputString);
        }
    }
    ?>
